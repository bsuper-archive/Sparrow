...
//        SQLiteUtils.execSql("DROP TABLE DBTweets");
    ...
    public static void saveMessageToDB(Context context, String recipient, String msg) {
        Log.d(TAG, "Message is: " + msg);
        incrementVCTime(context);
        Utils.constructNewTweet(context, new Random().nextInt(), Utils.getOrCreateNewUUID(context).toString(), recipient, msg);
    }
}
